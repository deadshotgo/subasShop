...
@section('content')
    ...
    <!-- START SLIDER AREA -->
    <div style="background-image: url('images/bg/home.jpg') ;" class="slider-area bg-3 bg-opacity-black-60 ptb-150 mb-80">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="product-item">
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img style="width: 270px; height: 300px" src="/{{$randProduct->images}}" alt=""/>
                                    </a>
                                </div>
