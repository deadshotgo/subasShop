...
<div class="right_col" role="main">
        ...
        <div class="table-responsive">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Бренди <small>тест</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="dropdown">
                                <a style="color: #00aeef" href="{{route('Brand.create')}}"><i
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatable-buttons_info">
                                        ...
                                        @foreach($brands as $brand)
                                            <tr role="row" class="@if($loop->index % 2 == 0 )odd @else even @endif">
                                                ...
                                                <td><a class="btn btn-primary btn-sm "  href="{{route('Brand.edit',$brand->id)}}">Редагувати</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
