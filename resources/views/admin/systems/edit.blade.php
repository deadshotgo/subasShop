                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate=""
                                              ...
                                              novalidate="" action="{{ route('System.update',$system->id)}}" method="POST">
                                            @method('PUT')
                                            @csrf
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" name="title" value="{{$system->title}}" id="name" required="required"
                                                           class="form-control ">
                                                </div>
                                            </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate=""
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" name="title_m" value="{{$system->title_m}}" id="name" required="required"
                                                           class="form-control ">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <textarea class="form-control" name="description_m" >{{$system->description_m}}</textarea>
                                                </div>
                                            </div>
                                            <div class="ln_solid"></div>
                                            <div class="item form-group ">
